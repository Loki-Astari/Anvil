...
{
    if (addressRegValue == "Global")
    {
        instructions[0] |= Jump_Reg_Global;
    }
    else if (addressRegValue == "FramePointer")
    {
        instructions[0] |= Jump_Reg_FramePointer;
    }
    else if (addressRegValue == "This")
    {
        instructions[0] |= Jump_Reg_This;
    }
    else if (addressRegValue == "Extra")
    {
        instructions[0] |= Jump_Reg_Extra;
    }
    else if (addressRegValue == "StackPointer")
    {
        instructions[0] |= Jump_Reg_StackPointer;
    }
    else if (addressRegValue == "Expr-1")
    {
        instructions[0] |= Jump_Reg_Expr_1;
    }
    else if (addressRegValue == "Expr-2")
    {
        instructions[0] |= Jump_Reg_Expr_2;
    }
    else if (addressRegValue == "Expr-3")
    {
        instructions[0] |= Jump_Reg_Expr_3;
    }
    else
    {
        return false;
...
bool Assembler::assemble_JumpConditionFlag(std::string const& flagValue)
{
    if (flagValue == "AL")
    {
        instructions[0] |= Jump_Condition_AL;
    }
    else if (flagValue == "EQ")
    {
        instructions[0] |=  Jump_Condition_EQ;
    }
    else if (flagValue == "NE")
    {
        instructions[0] |=  Jump_Condition_NE;
    }
    else if (flagValue == "LT")
    {
        instructions[0] |=  Jump_Condition_LT;
    }
    else if (flagValue == "GT")
    {
        instructions[0] |=  Jump_Condition_GT;
    }
    else if (flagValue == "LE")
    {
        instructions[0] |=  Jump_Condition_LE;
    }
    else if (flagValue == "GE")
    {
        instructions[0] |=  Jump_Condition_GE;
    }
    else
    {
        return false;
...
int Assembler::assemble_Jump(std::istream& lineStream, bool buildSymbols)
{
    ...
    if (cmd == "Return")
    {
        return assemble_JumpReturn(lineStream);
    }
    else if (cmd == "Call")
    {
        instructions[0] |= Act_Jump | JumpType_Call;
    }
    else
    {
